...
namespace blank
{
    ...
    void Logger::init(int log_level)
    {
        ...
        logging::add_console_log(
            std::cout,
            keywords::format = "[%BlankHTTP%] [%TimeStamp%] [%ThreadID%] [%Severity%] %Message%");
        logging::core::get()->add_global_attribute("BlankHTTP", attrs::constant<std::string>("BlankHTTP"));
